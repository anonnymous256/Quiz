...
class _QuizPageState extends State<QuizPage> {
  ...
  List<Question> questions = [
    Question('Qual é o inicial de água da terceira geração?', 3,
        ['Squirtle', 'Totodile', 'Froakie', 'Mudkip']),
    Question('Qual é o golpe de água mais forte?', 0,
        ['Hydro-pump', 'Flash-Cannon', 'Water-Pulse', 'Ice-Punch']),
    Question('Qual a evolução do Frogadier?', 0,
        ['Greninja', 'Froakie', 'Blastoise', 'Gyarados']),
    Question('Quantos pokemons existem do tipo água?', 1,
        ['524', '164', '97', '245']),
    Question('Qual a fraqueza do tipo água?', 2,
        ['Fogo/Gelo', 'Elétrico/Fada', 'Planta/Elétrico', 'Aço/Dragão']),
  ];
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('lib/assets/images/agua1.jpeg'),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
